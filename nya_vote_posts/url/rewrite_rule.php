...
$forum_rewrite_rules['/^vote_posts[\/_-]?reply[\/_-]?([0-9a-z]+)(\.html?|\/)?$/i'] = 'misc.php?r=nya_vote_posts/vote_posts/comment/rid/$1';
...
$forum_rewrite_rules['/^vote_posts[\/_-]?(plus|minus)[\/_-]?([0-9a-z]+)[\/_-]?([0-9a-z]+)(\.html?|\/)?$/i'] = 'misc.php?r=nya_vote_posts/vote_posts/$1/pid/$2/uid/$3';
